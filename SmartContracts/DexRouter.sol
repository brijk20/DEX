...
contract DexSwapRouter02 is IDexSwapRouter02 {
    ...
    function _swapSupportingFeeOnTransferTokens(address[] memory path, address _to) internal virtual {
        for (uint i; i < path.length - 1; i++) {
            ...
            amountOutput = DexSwapLibrary.getAmountOut(amountInput, reserveInput, reserveOutput);
            }
    ...
    {
        return DexSwapLibrary.getAmountOut(amountIn, reserveIn, reserveOut);
    }
    ...
    {
        return DexSwapLibrary.getAmountIn(amountOut, reserveIn, reserveOut);
    }
...
library DexSwapLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'099747469f6e33998b652c9d88e00830db4eebfc9b7de29436896f61f2f0b132' // init code hash
            ))));
    }
